...
| 文档 | 描述 |
|------|------|
| [分层边界审计（2026-05）](./docs/understand/LAYERED_ARCHITECTURE_BOUNDARY_AUDIT_2026-05.md) | 现状代码分层边界收口报告与 API 拆分状态 |
| [分层迁移详细计划（2026-05）](./docs/understand/LAYERED_MIGRATION_PLAN_2026-05.md) | 迁移计划、完成度、风险与后续步骤的详细记录 |
